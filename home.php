...
$q3 = mysql_query("select product.product_name, product.file, categories.gambar from product,categories where product.id_category=categories.id and id_category=2 ORDER BY id_product DESC");
$s3 = mysql_query("select file from product ORDER BY id DESC");
